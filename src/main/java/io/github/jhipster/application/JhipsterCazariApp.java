...
public class JhipsterCazariApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterCazariApp.class);

    private final Environment env;

    public JhipsterCazariApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterCazari.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterCazariApp.class);
